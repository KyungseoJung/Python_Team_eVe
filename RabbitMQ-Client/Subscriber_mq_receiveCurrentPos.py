...
# //#15 fix: Flask를 거치지 않고, Node.js가 서버로 작동해 RabbitMQ로부터 데이터를 수신받는 코드를 구현
# import pika
...
@app.route('/')
def index():
    return render_template('index_mq_ver2_receiveCurrentPosMap.html', messages=messages)  #//#4 index.html로 메시지들을 함께 전달
